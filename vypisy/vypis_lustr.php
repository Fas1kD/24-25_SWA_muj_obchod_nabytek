...
$sql = "SELECT ID_nabytek, nazev_nabytku, Cena, prodejna FROM nabytek WHERE ID_nabytek = 8";
...
if ($result->num_rows > 0){
    ...
    while($row = $result->fetch_assoc()){
        echo '<img style="width: 250px; height: 400px; margin-bottom: 25px; morgin-top: 20px;" src="obrazky/lstr.png" alt="Obrázek produktu" ">';
